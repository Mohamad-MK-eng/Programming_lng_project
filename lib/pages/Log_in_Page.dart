  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
        ...
        child: Column(
          children: [Text('Welcome To'), Text('SHOP LOCAL')],
        ),
      ),
      Spacer(
        flex: 1,
  ...
  ///*    // إذا لم يكن هناك اتصال، أظهر رسالة للمستخدم */,الإنترنت والمحاولة مرة أخرى."),
         ...
         if (Provider.of<ProductsProvider>(context, listen: false)
           ...
           Provider.of<ProductsProvider>(context, listen: false)
               .ListOfProducts = await service.getProductService();
         }
     ...
     showDialog(
       ...
       builder: (ctx) => AlertDialog(
         title: Text("خطأ"),
         content: Text("حدث خطأ أثناء جلب البيانات: تحقق من الاتصال بالأنترنت!"),
         actions: [
           TextButton(
             onPressed: () {
